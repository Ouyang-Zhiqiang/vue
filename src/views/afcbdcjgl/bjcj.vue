...
export default {
  ...
  created(){
    ...
    this.prizeList=JSON.parse(this.form.awardsetting)
  },
  methods: {
    toTrue(){
      ...
      this.$axios.post('https://www.facebodyfitness.com/hi/main?hi=24CQRLLNXMBH', this.$qs.stringify(this.form), {headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then((res)=>{
        this.$message({
          message: '恭喜你，操作成功',
          type: 'success'
          })
