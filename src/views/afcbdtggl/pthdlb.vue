<template>
  <div id="container" style="padding:15px">
    <el-button type="success" @click="createActivity()">新增团购活动</el-button>
    
    <el-dialog title="新增团购活动" :visible.sync="dialogFormVisible" style="width:1200px;margin:0 auto">
      <el-form :model="form">
        ...
        <el-form-item label="团购价格" :label-width="formLabelWidth">
          <el-input v-model="form.grouppurchaseprice" style="width:270px;float:left" />&nbsp;&nbsp;&nbsp;&nbsp;元
        </el-form-item>
        <el-form-item label="参团人数" :label-width="formLabelWidth">
          <el-input v-model="form.groupsize" style="width:270px;float:left" />&nbsp;&nbsp;&nbsp;&nbsp;人
        </el-form-item>
        <el-form-item label="团购限时" :label-width="formLabelWidth">
          <el-input v-model="form.grouptime" style="width:270px;float:left" />&nbsp;&nbsp;&nbsp;&nbsp;小时
        </el-form-item>
        ...
        <el-form-item label="团购标题" :label-width="formLabelWidth">
          <el-input v-model="form.grouptitle" style="width:270px;float:left" />
        </el-form-item>
    ...
    <el-dialog title="编辑团购活动" :visible.sync="dialogFormVisible2" style="width:1200px;margin:0 auto">
      <el-form :model="updateform">
        ...
        <el-form-item label="团购价格" :label-width="formLabelWidth">
          <el-input v-model="updateform.grouppurchaseprice" style="width:270px;float:left" />&nbsp;&nbsp;&nbsp;&nbsp;元
        </el-form-item>
        <el-form-item label="参团人数" :label-width="formLabelWidth">
          <el-input v-model="updateform.groupsize" style="width:270px;float:left" />&nbsp;&nbsp;&nbsp;&nbsp;人
        </el-form-item>
        <el-form-item label="团购限时" :label-width="formLabelWidth">
          <el-input v-model="updateform.grouptime" style="width:270px;float:left" />&nbsp;&nbsp;&nbsp;&nbsp;小时
        </el-form-item>
        ...
        <el-form-item label="团购标题" :label-width="formLabelWidth">
          <el-input v-model="updateform.grouptitle" style="width:270px;float:left" />
        </el-form-item>
        <el-form-item label="秒杀描述" :label-width="formLabelWidth">
          <el-input
            v-model="updateform.groupdescription"
            style="width:270px;float:left;"
            type="textarea"
            :autosize="{ minRows: 2, maxRows: 4}"
          />
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="margin-top:20px">
      ...
      <el-table-column width="100" align="center" label="团购价格">
        <template slot-scope="scope">
          <span style="cursor:pointer">{{ scope.row.grouppurchaseprice }}</span>
        </template>
      </el-table-column>

      <el-table-column width="100" align="center" label="参团人数">
        <template slot-scope="scope">
          <span style="cursor:pointer">{{ scope.row.groupsize }}</span>
        </template>
      </el-table-column>

      <el-table-column width="100" align="center" label="团购限时">
        <template slot-scope="scope">
          <span style="cursor:pointer">{{ scope.row.grouptime }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column class-name="status-col" label="团购标题" width="120">
        <template slot-scope="scope">
          <span style="cursor:pointer">{{ scope.row.grouptitle }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="团购描述" width="120">
        <template slot-scope="scope">
          <span style="cursor:pointer">{{ scope.row.groupdescription }}</span>
        </template>
      </el-table-column>
  ...
  components: { Pagination },
    ...
    methods:{
      ...
      toTrueClose(){
        ...
        this.$axios.post('https://www.facebodyfitness.com/web/marketingMakeupgroupBase/addMarketingMakeupgroupBase', this.$qs.stringify(this.form), {headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then((res)=>{
         this.$message({
            message: '恭喜你，操作成功',
            type: 'success'
            })
      ...
      toGetAll(){
        this.$axios.post('https://www.facebodyfitness.com/web/marketingMakeupgroupBase/marketingMakeupgroupBaseMapperList', this.$qs.stringify(this.listQuery), {headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then((res)=>{
          // console.log(res)
          this.list=res.data
      ...
      toTrueClose2(){
        ...
        this.$axios.post('https://www.facebodyfitness.com/hi/main?hi=24CQRLLNJVYP', this.$qs.stringify(this.updateform), {headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then((res)=>{
          this.$message({
            message: '恭喜你，操作成功',
            type: 'success'
            })
