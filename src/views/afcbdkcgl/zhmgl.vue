  ...
  <div id="container" style="padding:15px">
    <el-tabs type="border-card" style="margin-top:20px">
      <el-tab-pane label="动作库管理">
        ...
        <el-button type="success" @click="toOpen()">新增组合名</el-button>
        <el-button type="success">导出Excel</el-button>
        <el-dialog title="新增组合名" :visible.sync="dialogFormVisible" style="width:1200px;margin:0 auto">
        ...
        <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="margin-top:20px">
          ...
          <el-table-column align="center" label="组合名称" width="650">
            <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    getAllComment(data){
      ...
      this.$axios.post('https://www.facebodyfitness.com/hi/main?hi=24C2HHHWUVLM', {headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then((res)=>{
    ...
    toTrueClose(){
      ...
      this.$axios.post('https://www.facebodyfitness.com/hi/main?hi=24C2HHHWUVLQ', this.$qs.stringify(data), {headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then((res)=>{
    ...
    toTrueClose2(){
      ...
      this.$axios.post('https://www.facebodyfitness.com/hi/main?hi=24C2HHHWUVLO', this.$qs.stringify(data), {headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then((res)=>{
        this.$message({
          message: '恭喜你，操作成功',
          type: 'success'
        })
