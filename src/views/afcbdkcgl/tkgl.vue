<template>
  <div>
    <div id="container" style="padding: 50px">
        ...
        <el-form :model="form">
          ...
          <div style="width: 100%; height: 300px">
            ...
            <div style="width: 14.2%; height: 200px; float: left">
              <el-select
                v-model="form1.coachid"
                style="width: 90%; margin-top: 5px; margin-left: 5px"
                placeholder="教练"
              >
                <el-option
              ...
              <el-select
                v-model="form1.cid"
                style="width: 90%; margin-top: 10px; margin-left: 5px"
                placeholder="课程大类"
                @change="getCourseItem1(form1.cid, form1.strenth, 0)"
              >
                <el-option
              ...
              <el-select
                v-model="form1.strenth"
                style="width: 90%; margin-top: 10px; margin-left: 5px"
                placeholder="强度"
                @change="getCourseItem1(form1.cid, form1.strenth, 0)"
              >
                <el-option
                  v-for="item in strenth"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
              ...
              >
                <el-option
                  v-for="item in strenthNumberArr1"
                  :key="item.mysid"
                  :label="item.strengthnumber"
                  :value="item.mysid"
                />
              </el-select>
            </div>
            <div style="width: 14.2%; height: 200px; float: left">
              ...
              <el-select
                ...
                style="width: 90%; margin-top: 10px; margin-left: 5px"
                placeholder="课程大类"
                @change="getCourseItem2(form2.cid, form2.strenth, 0)"
              >
                <el-option
                  v-for="item in courseType"
                  :key="item.cid"
              ...
              >
                <el-option
                  v-for="item in strenthNumberArr2"
                  :key="item.mysid"
                  :label="item.strengthnumber"
                  :value="item.mysid"
                />
            ...
            <div style="width: 14.2%; height: 200px; float: left">
              ...
              <el-select
                ...
                style="width: 90%; margin-top: 10px; margin-left: 5px"
                placeholder="课程大类"
                @change="getCourseItem3(form3.cid, form3.strenth, 0)"
              >
                <el-option
                  v-for="item in courseType"
                  :key="item.cid"
              ...
              >
                <el-option
                  v-for="item in strenthNumberArr3"
                  :key="item.mysid"
                  :label="item.strengthnumber"
                  :value="item.mysid"
                />
            ...
            <div style="width: 14.2%; height: 200px; float: left">
              ...
              <el-select
                ...
                style="width: 90%; margin-top: 10px; margin-left: 5px"
                placeholder="课程大类"
                @change="getCourseItem4(form4.cid, form4.strenth, 0)"
              >
                <el-option
                  v-for="item in courseType"
                  :key="item.cid"
              ...
              >
                <el-option
                  v-for="item in strenthNumberArr4"
                  :key="item.mysid"
                  :label="item.strengthnumber"
                  :value="item.mysid"
                />
            ...
            <div style="width: 14.2%; height: 200px; float: left">
              ...
              <el-select
                ...
                style="width: 90%; margin-top: 10px; margin-left: 5px"
                placeholder="课程大类"
                @change="getCourseItem5(form5.cid, form5.strenth, 0)"
              >
                <el-option
                  v-for="item in courseType"
                  :key="item.cid"
              ...
              >
                <el-option
                  v-for="item in strenthNumberArr5"
                  :key="item.mysid"
                  :label="item.strengthnumber"
                  :value="item.mysid"
                />
            ...
            <div style="width: 14.2%; height: 200px; float: left">
              ...
              <el-select
                ...
                style="width: 90%; margin-top: 10px; margin-left: 5px"
                placeholder="课程大类"
                @change="getCourseItem6(form6.cid, form6.strenth, 0)"
              >
                <el-option
                  v-for="item in courseType"
                  :key="item.cid"
              ...
              >
                <el-option
                  v-for="item in strenthNumberArr6"
                  :key="item.mysid"
                  :label="item.strengthnumber"
                  :value="item.mysid"
                />
            ...
            <div style="width: 14.2%; height: 200px; float: left">
              ...
              <el-select
                ...
                style="width: 90%; margin-top: 10px; margin-left: 5px"
                placeholder="课程大类"
                @change="getCourseItem7(form7.cid, form7.strenth, 0)"
              >
                <el-option
                  v-for="item in courseType"
                  :key="item.cid"
              ...
              >
                <el-option
                  v-for="item in strenthNumberArr7"
                  :key="item.mysid"
                  :label="item.strengthnumber"
                  :value="item.mysid"
                />
      ...
      <el-calendar
        :range="dateRange"
        style="text-align: center; height: 1050px !important"
      >
        <template
          slot="dateCell"
        ...
        >
          ...
          <div
            ...
            :key="index"
            style="width: 98%; margin: 0 auto; text-align: left"
          >
...
export default {
  ...
  methods: {
    ...
    getWeek(currentDay) {
      ...
      this.preDay = new Date(new Date(dates[0]).getTime() - 24 * 60 * 60 * 1000)
        .toLocaleDateString()
        .replace(/\//g, "-");
      // console.log('pre:  '+this.preDay)
      this.nexDay = new Date(new Date(dates[6]).getTime() + 24 * 60 * 60 * 1000)
        .toLocaleDateString()
        .replace(/\//g, "-");
    ...
    getCourseItem1(cid, strenth, index) {
      ...
      this.$axios
        ...
        .then((res) => {
          this.strenthNumberArr1 = res.data;
        });
    },
    getCourseItem2(cid, strenth, index) {
      ...
      this.$axios
        ...
        .then((res) => {
          this.strenthNumberArr2 = res.data;
        });
    },
    getCourseItem3(cid, strenth, index) {
      ...
      this.$axios
        ...
        .then((res) => {
          this.strenthNumberArr3 = res.data;
        });
    },
    getCourseItem4(cid, strenth, index) {
      ...
      this.$axios
        ...
        .then((res) => {
          this.strenthNumberArr4 = res.data;
        });
    },
    getCourseItem5(cid, strenth, index) {
      ...
      this.$axios
        ...
        .then((res) => {
          this.strenthNumberArr5 = res.data;
        });
    },
    ...
    getCourseItem7(cid, strenth, index) {
      ...
      this.$axios
        ...
        .then((res) => {
          this.strenthNumberArr7 = res.data;
        });
    },
    toFalse() {
    ...
    toTrue() {
      ...
      if (
        ...
        this.formList.forEach((item, index) => {
          ...
          if (
            item.coachid == "" ||
            item.coachid == undefined ||
            item.cid == "" ||
            item.cid == undefined ||
            item.sid == "" ||
            item.sid == undefined ||
            item.strenth == "" ||
            item.strenth == undefined
          ) {
          } else {
