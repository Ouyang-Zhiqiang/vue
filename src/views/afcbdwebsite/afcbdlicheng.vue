<template>
  <div id="container" style="padding:50px">
    ...
    <el-tabs type="border-card" style="margin-top:20px">
      <el-tab-pane label="官网里程介绍">
        <el-button type="success" @click="toOpen()">新增里程介绍</el-button>

        <el-dialog title="新增里程" :visible.sync="dialogFormVisible" style="width:1200px;margin:0 auto">
          <el-form :model="obj">
            <el-form-item label="里程时间" :label-width="formLabelWidth">
            ...
            <el-form-item label="里程描述" :label-width="formLabelWidth">
...
export default {
  ...
  methods: {
    ...
    teDelete(item){
        var obj={}
        obj=item
        this.$axios.post('https://www.facebodyfitness.com/hi/main?hi=24CDIAEC1UEK', this.$qs.stringify(obj), {headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then((res)=>{
         this.getAllList()
         this.$message({
            message: '恭喜你，操作成功',
            type: 'success'
    ...
    updateImg(){
      this.$axios.post('https://www.facebodyfitness.com/hi/main?hi=24CDIAEC1UEW', this.$qs.stringify(this.updateForm), {headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then((res)=>{
         this.getAllList()
    ...
    // },
    getAllList(){
      this.$axios.post('https://www.facebodyfitness.com/hi/main?hi=24CDIAEC0X8M', {headers: {'Content-Type':'application/x-www-form-urlencoded'}}).then((res)=>{
